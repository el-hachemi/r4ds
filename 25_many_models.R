...
#~~~~~~~~~~~~~~
  ...
  # we’re going to look into the “gapminder” data. This data was popularised by Hans Rosling, a Swedish doctor and statistician. He is a fantastic data presenter and illustrates how you can use data to present a compelling story. A good place to start is this short video filmed in conjunction with the BBC: https://www.youtube.com/watch?v=jbkSRLYSojo.
...
by_country %>%
  ...
  geom_jitter(width = 0.5)
      ...
      # Another solution from https://rstudio-pubs-static.s3.amazonaws.com/216759_35331865789e447c866f616010b23bdd.html
...
glance %>%
  ...
  scale_y_continuous(limits = c(0,1))
      ...
      # The r.squared improved considerably with a more flexible, quadratic model. Let’s visualize outliers with a boxplot:
...
df2 %>% unnest(y, z)
  ...
  #~~~~~~~~~~~~~~~~
    ...
    # > 2. List the most common types of vector found in a data frame. What makes lists different?
      ...
      # The common types of vectors in data frames are: logical, numeric, integer, character, factor. All of the common types of vectors in data frames are atomic. Lists are not atomic since they can contain other lists and other vectors.
